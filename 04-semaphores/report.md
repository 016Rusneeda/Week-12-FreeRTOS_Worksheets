...
## 🧪 การทดลอง
### ทดลองที่ 1: การทำงานปกติ
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/700f58db-a777-481d-9006-00e24f9013c4" />

### ทดลองที่ 2: เพิ่มจำนวน Resources
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/35013bbf-e180-4e15-913a-01cc00f95bf4" />

### ทดลองที่ 3: เพิ่ม Producers
<img width="1920" height="1080" alt="image" src="https://github.com/user-attachments/assets/63630e5d-d2f0-47ba-b2d2-587011fdf580" />


### ตารางผลการทดลอง
| ทดลอง | Resources | Producers | Success Rate | Avg Wait | Resource Utilization |
|-------|-----------|-----------|--------------|----------|---------------------|
| 1 (3R, 5P) | 3 | 5 |100.0% |1119ms | 90 %|
| 2 (5R, 5P) | 5 | 5 |100.0% | 2559ms| 70%|
| 3 (3R, 8P) | 3 | 8 |100.0%| 4916ms|100% |

### คำถามสำหรับการทดลอง
1. เมื่อ Producers มากกว่า Resources จะเกิดอะไรขึ้น?
   * เมื่อ Producers มากกว่า Resources จะเกิด การรอคิว Tasks ที่มาช้าจะต้องรอให้ resource ว่างก่อนจึงจะได้เข้าถึง และอาจเกิด timeout หากรอนานเกิน 8 วินาที (ตาม pdMS_TO_TICKS(8000))

2. Load Generator มีผลต่อ Success Rate อย่างไร?
   * ตอบ Load Generator มีผลทำให้ Success Rate ลดลงชั่วคราว เพราะเพิ่มความหนาแน่นของการขอ resource พร้อมกัน แต่ระบบยังคงเสถียร เนื่องจาก Counting Semaphore ช่วยจัดการลำดับคิวอย่างปลอดภัย

3. Counting Semaphore จัดการ Resource Pool อย่างไร?
   * ตอบ จัดการ Resource Pool แบบปลอดภัย ป้องกันการแย่งกันใช้ resource
